...
public class LevelSelect extends AppCompatActivity
{
    ...
    private LevelSelect.MyViewPagerAdapter myViewPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myViewPagerAdapter = new LevelSelect.MyViewPagerAdapter();
    ...
    private void launchLevelScreen() {
        startActivity(new Intent(LevelSelect.this, LevelScreen.class));
        finish();
    }
