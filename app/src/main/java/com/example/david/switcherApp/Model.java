...
public class Model {
	...
	//NOTE: I know ArrayLists are an inefficient way to store objects in a grid, but apparently HashMaps aren't supposed to have mutable keys, so I couldn't use them
	//In the future, if I work on another project like this, I will do more research to find the right data structure
	private ArrayList<GameObject> objList = new ArrayList<GameObject>(); //list of all objects, to keep track of them
